package com.kabba.transform.config;
...
@Configuration
//扫描 Mapper 接口并容器管理
@MapperScan(basePackages = {"com.kabba.transform.dao.sqlserver"}, sqlSessionFactoryRef = "sqlserverFactory")
public class SqlserverDataSourceConfig {
    ...
    public SqlSessionFactory sqlserverFactory(@Qualifier("sqlserverDataSource") DataSource dataSource) throws Exception {
        ...
        bean.setTypeAliasesPackage("com.kabba.transform.entity.generation");
